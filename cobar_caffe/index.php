...
<div class="container">
	<h1 class="text-center">Selamat Datang di <span class="text-primary"><strong>Caffe</strong></span> </h1>
	<h1 class="text-center"><span class="text-primary"><b><i>Coding Bareng</i></b></span> </h1>
